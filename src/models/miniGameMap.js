export const MINI_GAME_MAP = [
  // aman 1
  {
    ...
    ui: 'mcq',
    introduction:
      "Aman mentioned the five Ks of Sikhism - Let's find out more.",
    questions: [
      {
        question_id: 1,
      ...
      },
      {
        ...
        correct_answer_id: 3,
        explanation:
          'Initiated Sikhs (male or female) are not supposed to cut hair from any part of their body',
        type: 'text',
        answers: [
          {
            answer_id: 1,
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer_id: 4,
            title: 'No, so they carry an image of it instead',
          },
        ],
      },
    ],
...

  {
    ...
    ui: 'mcq',
    introduction:
      "Why did Nadia and Chloe have that chat? Let's find out more.",
    questions: [
      {
        question_id: 1,
      ...
      },
      {
        ...
        correct_answer_id: 3,
        explanation:
          'The images above include a Burka (blue), a Niqab (black), and a Khimar (dark green). The Hijab (light green image) is principle of modesty in Islam, extending to clothing and behaviour for both men and women, and usually refers to the head covering Muslim women wear. A Tudung is a Malay word for head-covering.',
        type: 'image',
        answers: [
          {
            answer_id: 1,
  ...
  // nadia chapt 2
  {
    ...
    ui: 'mcq',
    introduction:
      "Nadia and Gavin have touched on some pretty deep cultural issues. Let's find out more.",
    questions: [
      {
        question_id: 1,
        ...
        answers: [
          {
            answer_id: 1,
            title:
              'Yes, They can only eat food from halal-certified eateries. ',
          },
          {
            answer_id: 2,
            title:
              'No, they can eat from halal-certified eateries /  sources that are Muslim-owned.',
          },
          {
            answer_id: 3,
            title:
              '- No, they can eat from any sources so long it has no pork or no lard.',
          },
        ],
      },
      {
        question_id: 3,
        question: 'Which of the following meat dishes is NOT halal?',
        correct_answer_id: 3,
        explanation:
          'Frog meat is considered as haram (non-halal) by most Islamic scholars, because such ‘water creatures’ are considered unclean (along with alligators and turtles). Halal (lawful) food are items prepared under strict Muslim dietary laws, and animals, like chicken, sheep, cattle, must be slaughtered by Muslims because a short prayer is said when they are being slaughtered.',
        type: 'text',
        answers: [
          {
            answer_id: 1,
  ...
  //  nadia chapt 3
  {
    ...
    ui: 'mcq',
    introduction:
      "Interfaith relationships are a difficult and sensitive topic. Let's find out more.",
    questions: [
      {
        question_id: 1,
      ...
      },
      {
        question_id: 2,
        question:
          'How many Malay Muslim females married Chinese males in 2020?',
        correct_answer_id: 2,
        explanation:
      ...
      },
      {
        question_id: 3,
        question:
          "Mdm Che Zahara, a Malay Muslim pioneer of Singapore who helped establish the Singapore Women's Charter in Parliament in 1961, was married to a non-Malay.",
        correct_answer_id: 1,
        explanation:
          "Born in Singapore, Che Zahara was the daughter of Noor Mohamed, one of the first Malays during British rule to learn English and work as a mediator and translator. Che Zahara married a businessman from Ceylon, now Sri Lanka. She was inducted to the Singapore Women's Hall of Fame.",
  ...
  // aman 2
  {
    ...
    ui: 'mcq',
    introduction:
      "Aman faced hurdles on his journey to become an actor. Let's explore these.",
    questions: [
      {
        question_id: 1,
        question: 'Singapore already has a famous Sikh actor: Gurmit Singh.',
        type: 'text',
        correct_answer_id: 2,
        explanation:
      ...
      },
      {
        ...
        correct_answer_id: 1,
        explanation:
          "Based on the 2018 IPS Survey, 34% of Chinese respondents felt that a job applicant's race was sometimes important when hiring someone to work for them (compared to only 21% of Malays and 16% of Indians).",
        type: 'text',
        answers: [
          {
            answer_id: 1,
  ...
  // aman 3
  {
    ...
    ui: 'mcq',
    introduction:
      "Aman met Sel at a Gurdwara. Let's explore what this means to Sikhs.",
    questions: [
      {
        question_id: 1,
        question: 'A Gurdwara is a Sikh temple.',
        type: 'text',
        correct_answer_id: 1,
        explanation:
      ...
      {
        question_id: 2,
        question: 'Which one of these is most likely a Gurdwara?',
        correct_answer_id: 3,
        explanation:
          "It's option 3. A gurdwara can be identified from a distance by tall flagpoles bearing the orange & black Sikh flag, the Nishan Sahib (a logo with three swords and a special throwing weapon).",
        type: 'image',
        answers: [
          {
            answer_id: 1,
  ...
  // unaisah 1
  {
    ...
    ui: 'mcq',
    introduction:
      "Unaisah left her previous job because she faced some harassment. Let's explore this issue further.",
    questions: [
      {
        question_id: 1,
        question:
      ...
      },
      {
        ...
        correct_answer_id: 3,
        explanation:
          '13% reported being touched at work, or more than one in every ten workers. This included male respondees.',
        type: 'text',
        answers: [
          {
            answer_id: 1,
